    ...
    <section id="visit" className="section-pad bg-seaglass">
      <div className="container-x">
        ...
        <div className="grid gap-5 lg:grid-cols-2 lg:gap-8">
          <div className="reveal rounded-[var(--radius-card)] bg-foam p-4 shadow-[var(--shadow-ambient)] sm:p-8">
            <div className="mb-4 flex flex-wrap items-baseline justify-between gap-2">
              <h3 className="text-[24px]">Hours</h3>
          ...
          <div className="reveal flex flex-col gap-6 rounded-[var(--radius-card)] bg-foam p-6 shadow-[var(--shadow-ambient)] sm:p-8">
            <h3 className="text-[24px]">Find us</h3>
            <a
            ...
            >
              ...
              <span>
                <span className="block text-[19px] font-medium">{BUSINESS.street}</span>
            ...
            <a href={BUSINESS.phoneHref} className="flex items-center gap-4 hover:text-jade">
              ...
              <span className="num !text-[20px] font-medium">{BUSINESS.phoneDisplay}</span>
            </a>
