  ...
  return (
    <section id="drinks" className="section-pad">
      <div className="container-x grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="reveal rounded-[var(--radius-card)] bg-seaglass p-6 shadow-[var(--shadow-ambient)] sm:p-10">
          <div className="mb-6 flex items-baseline justify-between gap-4 border-b border-jade/20 pb-4">
            <h3 className="text-[24px] text-ink">Drink menu</h3>
            <span className="text-[15px] font-medium uppercase tracking-[0.1em] text-muted">One per guest</span>
          </div>
