...
export default function Footer() {
  ...
  return (
    <footer className="on-dark bg-ink px-4 pb-32 pt-16 text-foam sm:px-6 lg:px-12 lg:pb-14">
      <div className="container-x flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
        <img src={logoFullGold} alt={BUSINESS.name} width="720" height="621" loading="lazy" className="h-24 w-auto self-start" />
